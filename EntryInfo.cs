	...
	internal class EntryInfo // Inheritance for Event instead?
	{
		...
		*/
		...
		internal bool VisibleOnChecklist() {
			...
			bool HideUnavailable = !available() && BossChecklist.BossLogConfig.HideUnavailable && !BossUISystem.Instance.BossLog.showHidden; // entries that are labeled as not available
